...
![image-20250414182713928](../images/image-20250414182713928-c2384c46.png)
...
![image-20250415113303184](../images/image-20250415113303184-cc927de4.png)

禁用P-MOS管 出1时N-MOS断开 整个I/O成高阻态 或断路 小灯不亮 若出0 N-MOS激活 I/O与VSS链接N-MOS下的VSS链接 小灯两端都是0v也不会亮

![image-20250415113428587](../images/image-20250415113428587-3303d5c2.png)
...
![image-20250415113936049](../images/image-20250415113936049-554f2701.png)

在用片上外设 比如串口时的输出

## 上拉输入 下拉输入与浮空输入

![image-20250415114046421](../images/image-20250415114046421-d93618cd.png)

上拉输入时 I/O引脚的电流经过分叉 上面的开关闭合 下拉就是下面的闭合 浮空就是都不闭合

继续前进会遇到TTL肖特基触发器 即施密特触发器 

![image-20250415114241067](../images/image-20250415114241067-8fd8c3d9.png)

普通比较器进行模拟量转换时 由于只有一个参考电压 因高低电平快速变化而无法准确测得当前电平

![image-20250415114422767](../images/image-20250415114422767-605ff8ab.png)

施密特触发器由于有两个参考电压 在中间部分有缓冲区 能够稳定电压

![image-20250415114528108](../images/image-20250415114528108-11cf8a26.png)
...
![image-20250424215422865](../images/image-20250424215422865-374f9ee3.png)

![image-20250424215351392](../images/image-20250424215351392-9fcc40e9.png)

1.根据引脚图选出对应的引脚 选择GPIO Output 因为小灯根据我们给的高低电平而亮灭

2.System Core-GPIO-Configuration中 可以选择引脚的各种设置

![image-20250424215658917](../images/image-20250424215658917-37315d69.png)

以PA6为例 

GPIO output level是默认输出电平 这里选择Low 默认小灯不亮

GPIO mode是选择模式 ![image-20250424215831679](../images/image-20250424215831679-d136b1db.png)
...
![image-20250415170449771](../images/image-20250415170449771-ecb0119d.png)
...
![image-20250415170827429](../images/image-20250415170827429-c2da9aa9.png)

事件对应的处理器 事件送达后发送给外设 由外设自行处理

![image-20250415170924443](../images/image-20250415170924443-8d3c596b.png)

通过配置寄存器 选择上升沿/下降沿寄存器 选择是否需要往后输出一个高电平

![image-20250415171129122](../images/image-20250415171129122-f885ebb4.png)

如果对应引脚是下降沿 并被检测 那么经过一个或门到达请求挂起寄存器

其中我们也可以通过软件中断事件寄存器 通过软件手动给一个模拟1

![image-20250415171309182](../images/image-20250415171309182-d584edb5.png)

当检测完后 对应的位会在请求挂起寄存器中置1

![image-20250415171432991](../images/image-20250415171432991-afb189d9.png)
...
![image-20250415171706267](../images/image-20250415171706267-c81ec5ce.png)
...
![image-20250415172611114](../images/image-20250415172611114-e7f7bac3.png)

若某中断正在执行 另一中断突然发生

![image-20250415172746173](../images/image-20250415172746173-268a1425.png)

![image-20250415172805970](../images/image-20250415172805970-7c93df50.png)

## 在CUBE IDE中的用法与注意事项

![image-20250429205926043](../images/image-20250429205926043-92faedd6.png)

在GPIO选项中选择GPIO_EXTI12

在GPIO中有以下选项

![image-20250429210054967](../images/image-20250429210054967-e837b9e1.png)

GPIO mode中![image-20250429210132922](../images/image-20250429210132922-2c737da5.png)
...
GPIO Pull-up/Pull-down中![image-20250429210636699](../images/image-20250429210636699-2b1c5927.png)

选择上拉下拉或者悬空 决定了默认电平

这里KEY1有上拉电阻，所以选择悬空

选择完后 要记得打开中断![image-20250429211536425](../images/image-20250429211536425-7dbb70cd.png)
...
![image-20250415173622998](../images/image-20250415173622998-953fda93.png)

通过两设备的TX与RX相连 再由一些约定的高低电平变化完成通信

TX是发送IO RX是接收IO

![image-20250415173852724](../images/image-20250415173852724-fda0570e.png)
...
![image-20250416154958629](../images/image-20250416154958629-e0a5dba9.png)
...
![image-20250502185848605](../images/image-20250502185848605-a51c9cb7.png)

**使能串口中断**：在 USART2 -> Configuration -> NVIC Settings 标签卡中，勾选 USART2 global interrupt 的 Enable

这里使能串口中断是为了让串口空闲中断激活

![image-20250502185820163](../images/image-20250502185820163-12c5b2c7.png)
...
![image-20250502190242738](../images/image-20250502190242738-3de13008.png)
...
![image-20250416171121242](../images/image-20250416171121242-6f993f2a.png)
...
![image-20250416171136295](../images/image-20250416171136295-f0ae15f2.png)

每个从机都有对应的从机地址

![image-20250416171200473](../images/image-20250416171200473-f61d42aa.png)

主机通过在最开始发送从机地址 从而从机如果看到了是自己的地址 就发送应答 否则就选择性失聪

对于串口来说

![image-20250416171344737](../images/image-20250416171344737-14a40b1e.png)

双方都有自己的系统时钟 以一致的比特率进行通信 也叫异步通信 虽然能比较方便 但无法保证双方的系统时钟是精确的

![image-20250416171628330](../images/image-20250416171628330-2a2bc2ab.png)

对于一些小型的传感器来说并没有精确的晶振提供时钟基准

IIC选择同步通信 也就是主机发送统一的时钟信号 作为统一的时钟源 即SCL

![image-20250416171811122](../images/image-20250416171811122-adb3738f.png)

IIC两条线因为都有上拉电阻 所以初始都应是高电平

![image-20250416171845450](../images/image-20250416171845450-f46eaff3.png)

主机发送启动信号 提前下拉SDA 所有从机准备接受命令

在主机给从机发送信号时 

![image-20250416172334774](../images/image-20250416172334774-0ea61f06.png)
...
![image-20250503145835206](../images/image-20250503145835206-6775781a.png)

![image-20250503145926594](../images/image-20250503145926594-addf18ce.png)

![image-20250503150029656](../images/image-20250503150029656-ef1a8a56.png)
...
![image-20250503150409431](../images/image-20250503150409431-4b92e4e0.png)
...
![image-20250503150701444](../images/image-20250503150701444-60f6b0b0.png)

这一部分小时钟树由LSE和LSI构成，外设时RTC实时时钟和看门狗

![image-20250503150748442](../images/image-20250503150748442-8396ee1b.png)

这一部分是MCO 时钟输出功能

## TIM

![image-20250503150904224](../images/image-20250503150904224-e8164746.png)

定时器1-8被分为三类

![image-20250503151042468](../images/image-20250503151042468-7c282ae6.png)

当72MHz的信号经过1的预分频器 计数器一秒能数36M次 那么就叫做2分频

当72MHz的信号经过n-1的预分频器 计数器一秒能数72M/n次 那么就叫做n分频

![image-20250503151240027](../images/image-20250503151240027-0193ecbe.png)

![image-20250503151349342](../images/image-20250503151349342-8b2b7ce1.png)

可以设置重装载，记完后从0开始，并触发中断

### 在CUBE IDE中的用法与注意事项

![image-20250503152700281](../images/image-20250503152700281-1ae3a0ac.png)

把Internal Clock选上 意味着开启TIM4了

![image-20250503152733272](../images/image-20250503152733272-f3db32b1.png)

开启TIM4的中断

![image-20250503152854298](../images/image-20250503152854298-950af3f5.png)
...
![image-20250503154343715](../images/image-20250503154343715-4b1c7f20.png)
...
![image-20250503154649475](../images/image-20250503154649475-138e69f1.png)
...
![image-20250503160235015](../images/image-20250503160235015-9323745e.png)

先看这张图 除了内部时钟外 信号来源还有TI1 TI2 ETR

TI1 TI2是TIM1 INPUT和TIM2 INPUT 是定时器的输入通道

![image-20250503160441923](../images/image-20250503160441923-4698bad9.png)
...
![image-20250503160642394](../images/image-20250503160642394-e029fad2.png)
...
![image-20250503160849517](../images/image-20250503160849517-9528be70.png)

ETR经过这几个步骤 其中边沿检测只检测上升沿 但极性选择可改变上升沿与下降沿身份 那么极性选择和边沿检测共同作用可选择上升沿触发或者下降沿触发

![image-20250503161039548](../images/image-20250503161039548-013e4cf6.png)
...
![image-20250503163647943](../images/image-20250503163647943-658f7dfb.png)

因为要用外部输入进行计数 所以就要用到ETR 因为TIM3 4没有ETR 所以选择TIM2 并在Clock Source中选择ETR2 

![image-20250503163834736](../images/image-20250503163834736-e977f826.png)

因为这里是计数 所以就不分频 也不另外设置重装载了 另外Clock Filter是脉冲宽度 一般都是15 通俗来讲就是消除低于15的干扰信号

 

![image-20250503163927745](../images/image-20250503163927745-e075eb63.png)

在时钟树配置上 先不急着更改HCLK的时钟 就用8MHZ

![image-20250503164008754](../images/image-20250503164008754-4223ed4b.png)
...
![image-20250503165351562](../images/image-20250503165351562-a9f68564.png)

除了外部时钟模式2 我们还可以用外部时钟模式1 

![image-20250503165500961](../images/image-20250503165500961-9a679dc4.png)
...
![image-20250503165713025](../images/image-20250503165713025-2b6351a4.png)
...
![image-20250503182638970](../images/image-20250503182638970-e8d8302e.png)
...
![image-20250503182814414](../images/image-20250503182814414-cd2cfc41.png)

由于选了复位模式 外部时钟模式1不能给定时器提供计数信号

如果单纯想计时 则用内部时钟 如果想对外部信号进行计时 则用ETR 即外部时钟模式2

![image-20250503183103804](../images/image-20250503183103804-d22efcb4.png)

如果我们用TI1FP1作为从模式控制器的信号源 复位模式下就有两个地方能将定时器记0 一个是重装载寄存器 一个是外部信号的上升沿 而这两个地方都能触发定时器更新中断

### 在CUBE IDE中的用法与注意事项

![image-20250503183849825](../images/image-20250503183849825-c984868d.png)
...
![image-20250503184645262](../images/image-20250503184645262-c7805408.png)

因此分频为8000分频 重装载设成5000 要5s一次重装载

![image-20250503184736482](../images/image-20250503184736482-f9662019.png)
...
![image-20250503192011432](../images/image-20250503192011432-ceea663c.png)

若边沿检测器改为下降沿的话 则高低电平反过来

![image-20250503192107132](../images/image-20250503192107132-d78c12af.png)
...
![image-20250503193130314](../images/image-20250503193130314-f8e9189b.png)
...
![image-20250503193626241](../images/image-20250503193626241-92f53320.png)
...
![image-20250504132132220](../images/image-20250504132132220-eaef7e97.png)

超声波引脚如上

![image-20250504132203314](../images/image-20250504132203314-173bc7a8.png)

在测量时，控制端先拉高再拉低 当读取到下降沿时 输出端拉高 并放出超声波  

当模块检测到反射回来的超声波时，模块将Echo拉低 那么高电平的持续时间就是超声波的传输事件

![image-20250504132421626](../images/image-20250504132421626-719c46a2.png)
...
![image-20250504132646240](../images/image-20250504132646240-50d2e89e.png)

![image-20250504132825476](../images/image-20250504132825476-e852e6e7.png)
...
![image-20250504133618855](../images/image-20250504133618855-3b2d11b6.png)

接口引脚如图

![image-20250504134715054](../images/image-20250504134715054-68a79b82.png)

把PA11选择GPIO_Output 然后改为Trig

因为PA10中由TIM1_CH3的选项 所以我们选择TIM1的通道3和通道4 来进行输入捕获

![image-20250504135004466](../images/image-20250504135004466-bbca8677.png)

便于计算 将分频设为72分频 那就是1us记1次

![image-20250504135038279](../images/image-20250504135038279-c2935b9f.png)

两个通道设成这样

![image-20250504135055562](../images/image-20250504135055562-c527b1fd.png)

通道3用于捕获上升沿 通道4用于捕获下降沿 一个直接一个间接

代码中：

![image-20250504141054762](../images/image-20250504141054762-8ce50ae7.png)

先开启tim1 再开启tim1的3通道的输入捕获 再开启tim1的4通道的输出捕获 并设为中断模式 意为当4通道输入捕获捕获到下降沿时 开启中断 通知用户已捕获 尽快处理

![image-20250504141821517](../images/image-20250504141821517-be778700.png)

在while循环里 将trig引脚拉高再拉低 以触发超声波 并在此时将tim1的值设为0

![image-20250504142943669](../images/image-20250504142943669-74544ae2.png).在输入捕获下降沿的中断中 读取3通道和4通道的值 并计算出distance 

## PWM

![image-20250504153019574](../images/image-20250504153019574-38cad4e3.png)

![image-20250504153031698](../images/image-20250504153031698-e87ac9a5.png)

![image-20250504153052298](../images/image-20250504153052298-a7c32eca.png)

实际上 PWM就是用数字信号尽可能模拟模拟信号

![image-20250504153233136](../images/image-20250504153233136-7949aeef.png)
...
![image-20250504154008266](../images/image-20250504154008266-4c356c2c.png)

两种模式如上

而正因为这里讨论的是有效电平和无效电平 是因为比较寄存器输出时会经过一个输出控制器 这个可以定义有效电平为低还是高

![image-20250504154241757](../images/image-20250504154241757-5d4b1d0a.png)

### 在CUBE IDE中的用法与注意事项

我们要实现对小灯的PWM

![image-20250504181358336](../images/image-20250504181358336-eeceea8d.png)

可以看到PB0是TIM3的通道3 那么我们就配置TIM3

![image-20250504181845363](../images/image-20250504181845363-31e23960.png)

勾选上Internal Clock 并选择为PWM Generation CH3

![image-20250504181932840](../images/image-20250504181932840-0ada0316.png)

使72分频 并100重装载 那么比较值Pulse就是0-99

![image-20250504182046579](../images/image-20250504182046579-c68a9c51.png)

来到代码 

![image-20250504183315535](../images/image-20250504183315535-031ac862.png)

先开启三个通道的PWM模式

![image-20250504183335806](../images/image-20250504183335806-4ef1b01b.png)

再用__HAL_TIM_SET_COMPARE(&htim3,TIM_CHANNEL_3,i);对每个通道的PWM值进行修改 以此输出

## 编码器

![image-20250504183522453](../images/image-20250504183522453-35c08637.png)

未旋转时都保持高电平

旋转后如图变化 输出方波信号

![image-20250504183801923](../images/image-20250504183801923-e4a65534.png)

电机还能通过单位时间内电机的旋转角度 计算得到电机的旋转速度 

![image-20250504184010395](../images/image-20250504184010395-0459e32e.png)

我们通过定时器实现对编码器的读取

### 在CUBE IDE中的用法与注意事项

![image-20250504192203437](../images/image-20250504192203437-aaec0d0a.png)

选择encoder mode模式

![image-20250504192733224](../images/image-20250504192733224-a3f164e3.png)

选择2分频 因为一度是2 所以除以2

![image-20250504192810480](../images/image-20250504192810480-03fb4737.png)

AB相这样分 15滤波 一上一下 如果不一样就可以换一下极性

![image-20250504192906119](../images/image-20250504192906119-ba0b36a8.png)

代码中开启encode AB相都开了

![image-20250504193252067](../images/image-20250504193252067-757188db.png)
